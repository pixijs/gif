...
var AnimatedGIF = /** @class */ (function (_super) {
    ...
    function AnimatedGIF(frames, options) {
        ...
        _this = _super.call(this, Texture.from(canvas, { scaleMode: scaleMode })) || this;
    ...
    AnimatedGIF.prototype.update = function (deltaTime) {
        ...
        var elapsed = this.animationSpeed * deltaTime / settings.TARGET_FPMS;
...
export { AnimatedGIF, AnimatedGIFLoader };
